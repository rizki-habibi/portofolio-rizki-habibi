      ...
      <div className="border-b border-white/10 py-16 lg:py-24 text-center overflow-hidden">
        ...
        >
          <p className="font-mono text-xs text-white/25 uppercase tracking-widest mb-6">
            Ada kasus yang ingin diungkap?
          </p>
          <button
            onClick={() => gulirKe('kontak')}
            className="font-judul text-white hover:text-white/80 transition-colors duration-300 leading-none"
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-12">
        <div className="grid md:grid-cols-3 gap-8 lg:gap-12 mb-12">
          ...
          >
            ...
            <p className="font-mono text-xs text-white/35 leading-relaxed">
              Rizki Habibi — Jurnalis Investigatif & Aktivis Digital.
              Mengungkap kasus yang belum tuntas.
            </p>
            <div className="flex items-center gap-2">
              <span className="lencana-aktif w-1.5 h-1.5 rounded-full bg-white/50 inline-block" />
            ...
            <div className="grid grid-cols-2 gap-2">
              {[
                ...
                <button
                  ...
                  className="text-left font-mono text-xs text-white/30 hover:text-white/70 uppercase tracking-wider transition-colors duration-200"
                  data-hover
                >
                  {item.label}
                </button>
          ...
          >
            ...
            <div className="space-y-3">
              {[
                ...
                <button
                  key={i}
                  onClick={() => gulirKe('kasus')}
                  className="w-full text-left flex items-baseline gap-3 group"
                  data-hover
                >
                  <span className="font-mono text-xs text-white/20">{k.tahun}</span>
                  <span className="font-mono text-xs text-white/40 group-hover:text-white/70 transition-colors leading-snug">
                    {k.judul}
                  </span>
                </button>
              ))}
        ...
        >
          <p className="font-mono text-xs text-white/20">
            © {tahunSekarang} Rizki Habibi. Semua hak dilindungi.
          </p>
          <p className="font-mono text-xs text-white/15">
            Dibangun dengan React + Framer Motion — Di-host di Vercel
          </p>
        </motion.div>
      </div>
    </footer>
